...
namespace responsilast
{
    class Program
    {
        ...
        {
            Console.Title = "Responsi UAS Matakuliah Pemrograman Havida 19.11.2880";
        ...
        static void TambahPenjualan()
        {
            ...
            Console.Clear();
            Console.WriteLine("Tambahkan Data Penjualan\n");
...

        {
...

            {
                ...
                if (penjualan.nota == nota)
                {
                    ...
                    Console.WriteLine("Data dengan nama " + penjualan.nama + " dengan id " + penjualan.nota + " berhasil Dihapus!\n");
                }
                else{
